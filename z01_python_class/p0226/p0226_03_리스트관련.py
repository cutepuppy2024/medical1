...
list5 = ['짝수',[2,4,6], '홀수', [1,3,5]]  #list 자체도 하나의 요소로 사용가능
...
print(aa)
aa.remove(100) 
print(aa)  # 같은 값이 2개 이상인 경우 맨 앞의 값만 삭제되고 나머지는 유지됨
...
# in , not in
print(100 in aa) # True / False로 출력
print(200 not in aa)
print(2 in aa)
